...
export class PaymentService {
    ...
    async createCheckoutSession(lineItems, baseUrl, paymentMethod) {
        try {
    ...
    async handleWebhookEvent(payload, sig) {
        try {
    ...
    async createPaymentIntent(amount, imageIds) {
        try {
    ...
    async handlePaymentIntentSucceeded(payload, sig) {
        try {
